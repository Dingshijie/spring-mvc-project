...
<head>
	...
	<link rel="stylesheet" href="${initParam.resourceRoot}/css/area/list.css">
	<script type="text/javascript" src="${initParam.resourceRoot}/js/area/list.js"></script>
</head>
<body>
	<c:import url="../common/manager-top.jsp"></c:import>
	<c:import url="../common/manager-left.jsp"><c:param name="active">areamanager</c:param><c:param name="subactive">arealist</c:param></c:import>
