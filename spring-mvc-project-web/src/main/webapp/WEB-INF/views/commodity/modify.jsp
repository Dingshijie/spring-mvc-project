		...
		<div class="show-grid">
			<div id="mainList">
				<form class="form-horizontal col-md-offset-1 col-md-11" id="myForm" role="form" action="${webRoot }/commodity/add" method="post" enctype="multipart/form-data">
					...
					<fieldset>
						<legend>编辑商品   <label style="color: red">完善中</label></legend>
						...
						<div class="form-group col-md-6">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" style="width: 90%;display: inline-block;" id="price" name="price" value="${commodityinfo.price }" placeholder="价格（必填）">&nbsp;元
							</div>
						...
						<div class="form-group col-md-6">
							...
							<div class="col-sm-6 control-label">
								<div class="col-sm-5 ">
									<input name="used" type="radio" value="1" <c:if test="${commodityinfo.used==1 }">checked</c:if> >是
								</div>
								<div class="col-sm-5">
									<input name="used" type="radio" value="0" <c:if test="${commodityinfo.used==0 }">checked</c:if> >否
								</div>
							</div>
						</div>
						<div class="form-group col-md-10">
							...
							<div class="col-sm-10" style="padding-top: 7px;">
								<input name="newCondition" type="radio" value="全新" <c:if test="${commodityinfo.newCondition=='全新' }">checked</c:if> >全新<span style="margin-right: 5px;"></span>
								<input name="newCondition" type="radio" value="九成新" <c:if test="${commodityinfo.newCondition=='九成新' }">checked</c:if> >九成新<span style="margin-right: 5px;"></span>
								<input name="newCondition" type="radio" value="八成新" <c:if test="${commodityinfo.newCondition=='八成新' }">checked</c:if> >八成新<span style="margin-right: 5px;"></span>
								<input name="newCondition" type="radio" value="六成新" <c:if test="${commodityinfo.newCondition=='六成新' }">checked</c:if> >六成新<span style="margin-right: 5px;"></span>
								<input name="newCondition" type="radio" value="六成以下"<c:if test="${commodityinfo.newCondition=='六成以下' }">checked</c:if> >六成以下
							</div>
						</div>
						<div class="form-group col-md-9">
