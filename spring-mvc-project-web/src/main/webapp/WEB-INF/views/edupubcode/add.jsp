...
<head>
	...
	<script type="text/javascript" src="${initParam.resourceRoot}/js/edupubcode/add.js"></script>
	<link rel="stylesheet" href="${initParam.resourceRoot}/css/edupubcode/add.css" />

</head>
<body>

	<c:import url="../common/manager-top.jsp"></c:import>
	<c:import url="../common/manager-left.jsp"><c:param name="active">edupubcodemanager</c:param><c:param name="subactive">addedupubcode</c:param></c:import>
