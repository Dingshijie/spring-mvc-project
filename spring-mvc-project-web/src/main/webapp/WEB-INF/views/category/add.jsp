...
<head>
	...
	<!--  Bootstrap check 按钮 -->
	<link rel="stylesheet" href="${initParam.resourceRoot}/lib/bootstrap-switch/dist/css/bootstrap3/bootstrap-switch.min.css">
	...
	<script type="text/javascript" src="${initParam.resourceRoot}/lib/bootstrap-switch/dist/js/bootstrap-switch.min.js"></script>
	<script type="text/javascript" src="${initParam.resourceRoot}/lib/bootstrap/js/highlight.js"></script>
	<script type="text/javascript" src="${initParam.resourceRoot}/lib/bootstrap/js/main.js"></script>
				...
				<form class="form-horizontal" id="myForm" role="form">
					<fieldset>
						...
						<div class="form-group" style="margin-top: 20px;">
							<label for="username" class="col-sm-2 control-label">代码:</label>
							<div class="col-sm-2">
						...
						<div class="form-group">
							<label for="mobilPhone" class="col-sm-2 control-label">所属分类:</label>
							<div class="col-sm-2">
						...
						<div class="form-group">
							<label for="address" class="col-sm-2 control-label">是否设置为热门:</label>
							<div class="col-sm-2 bootstrap-switch-container">
								<input id="switch-hot" type="checkbox" data-on-label="SI" data-off-color="danger">
							</div>
							<div class="col-sm-3" style="margin-top: 5px;padding-left: 0px;margin-left: 0px;">
						...
						<div class="form-group">
							<label for="address" class="col-sm-2 control-label">是否设置为可用:</label>
							<div class="col-sm-2 bootstrap-switch-container">
								<input id="switch-enable" type="checkbox" data-off-color="danger">
							</div>
							<div class="col-sm-3" style="margin-top: 5px;padding-left: 0px;margin-left: 0px;">
								<span class="help-block" id="addresserror"></span>
							</div>
